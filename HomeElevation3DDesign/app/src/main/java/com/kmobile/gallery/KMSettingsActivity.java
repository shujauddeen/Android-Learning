...
public class KMSettingsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		pref = new KMPrefManager(getApplicationContext());
		...
		btnSave.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!googleUsername.equalsIgnoreCase(pref.getGoogleUserName())
					...
					Intent i = new Intent(KMSettingsActivity.this,
							KMSplashActivity.class);
