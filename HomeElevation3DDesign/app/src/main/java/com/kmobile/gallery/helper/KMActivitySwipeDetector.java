 ...
 */
public class KMActivitySwipeDetector implements View.OnTouchListener {

    static final String logTag = "ActivitySwipeDetector";
    private KMSwipeInterface activity;
    ...
    public KMActivitySwipeDetector(Context context, KMSwipeInterface activity){
